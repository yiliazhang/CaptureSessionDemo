...
@interface GWDetectFaceViewController ()<GWArcFaceCameraViewDelegate, UIGestureRecognizerDelegate>
/// 关闭视图控制器
...
@property (strong, nonatomic) GWArcFaceCameraView *faceCameraView;
@end

@implementation GWDetectFaceViewController
...
/// 动画间隔
CGFloat GWDetectFaceAnimationDuration = 0.3;
...
/// 自定义相机视图
- (GWArcFaceCameraView *)faceCameraView
{
    if (!_faceCameraView)
    {
        _faceCameraView = [[GWArcFaceCameraView alloc] init];
